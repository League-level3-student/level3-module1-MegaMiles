...
//  temperature, you can get a free API key at: https://openweathermap.org/api
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == WeatherSearch) {
			...
			for (String WeatherVAR : weatherData.keySet()) {
				if (weatherData.contains(Search)) {

				}
			}
		}
		if (e.getSource() == WeatherSpecify) {
			String Specify = JOptionPane.showInputDialog(null,
					"Please specify the weather conditions of the city you are look for(Hot, Cold, Cloudy, Raining, Snowing, Clear");
		}
